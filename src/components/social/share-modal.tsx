      ...
      <div className="relative bg-white rounded-2xl shadow-2xl p-6 w-full max-w-sm mx-4">
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3 mt-2">
            ...
            >
              <svg viewBox="0 0 24 24" width="24" height="24" className="text-green-600 flex-shrink-0">
            ...
            >
              <svg viewBox="0 0 24 24" width="24" height="24" className="text-blue-500 flex-shrink-0">
