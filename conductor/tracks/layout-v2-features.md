# CannaLog Layout V2 - Features

## Status: Active
## Track ID: layout-v2-features

### Goal
Implement the remaining feature requirements from the mockups (Strain of the Day, Taste/Effect selectors, Profile redesign).
