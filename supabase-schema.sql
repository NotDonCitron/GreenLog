...
CREATE TABLE organization_members (
  ...
  role TEXT CHECK (role IN ('gründer', 'admin', 'member', 'viewer', 'präventionsbeauftragter')) NOT NULL DEFAULT 'member',
...
CREATE TABLE organization_invites (
  ...
  organization_id UUID REFERENCES organizations(id) ON DELETE CASCADE NOT NULL,
  email TEXT NOT NULL,
  role TEXT CHECK (role IN ('admin', 'staff', 'member', 'viewer', 'präventionsbeauftragter')) NOT NULL DEFAULT 'member',
  token_hash TEXT,
